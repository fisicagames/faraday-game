...
**Faraday Game** é um jogo interativo que permite aos jogadores explorar o comportamento físico da indução eletromagnética que ocorre em uma bobina devido a variação de um fluxo magnético no seu interior. O objetivo é movimentar um ímã para alterar o fluxo magnético e induzir corrente elétrica na bobina, iluminando a lâmpada com a máxima intensidade que conseguir!

## Funcionalidades

* TODO
* O jogo é totalmente controlado por um único botão na tela, visando um design de interação simples e acessível para todos.
...
* **Arquitetura MVC** : Utilizada para organizar o código com eventos baseados em interfaces e callbacks.
...
1. **Objetivo** :TODO.
2. **Controles** : O jogo é controlado por um único botão.
3. **Modos**: O jogo oferece dois modos diferentes :
...
![1733704976277](image/README/1733704976277.png) ![1733705000233](image/README/1733705000233.png)
